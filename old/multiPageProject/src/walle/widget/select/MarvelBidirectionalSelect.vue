<template>
  <div class="bidirectionalSelectWrapper">
    <div class="leftPart">
      ...
      <div class="partOptionWrapper">
        <div class="partOptionSelectAll icon-stack"
             v-on:click="selectAllLeft">{{isItemAllSelectInLeft}}</div>
    ...
    <div class="rightPart">
      ...
      <div class="partOptionWrapper">
        <div class="partOptionSelectAll icon-stack"
             v-on:click="selectAllRight">{{isItemAllSelectInRight}}</div>
        <div class="partOptions">
          <div v-for="(item, index) in options.items"
...
<style scoped>
  ...
  *{box-sizing: border-box}
  ...
  .blackBg .bidirectionalSelectWrapper .partLabel{
    color: #ffffff;
  }
  .blackBg .bidirectionalSelectWrapper .partOptionWrapper{
    border: 1px solid #ccc;
    background-color: #000;
  }
  .blackBg .bidirectionalSelectWrapper .partOptionWrapper .partOptionSelectAll{
    border-bottom: 1px solid #ccc;
    color: #ffffff;
  }
  .blackBg .bidirectionalSelectWrapper .partOptionWrapper .partOptionSelectAll:before{
    color: #3399ff;
  }
  .blackBg .bidirectionalSelectWrapper .partOptionWrapper .partOptionSelectAll:hover{
    color: #3399ff;
  }
  .blackBg .bidirectionalSelectWrapper .partOptionWrapper .partOptions .partOptionItem{
    border-bottom: 1px dashed #ccc;
  }
  .blackBg .bidirectionalSelectWrapper .partOptionWrapper .partOptions .partOptionItem:hover{
    background-color: rgba(0, 124, 247, 0.2)
  }
  .blackBg .bidirectionalSelectWrapper .centerPart .btnWrapper .switchBtn{
    background-color: rgba(255,255,255,0.2);
    color: #3399ff;
  }
  .blackBg .bidirectionalSelectWrapper .centerPart .btnWrapper .active{
    background-color: #3399ff;
    color: #FFFFFF;
  }
  .blackBg .bidirectionalSelectWrapper .centerPart .btnWrapper .switchBtn:hover{
    background-color: #3399ff;
  }
  .blackBg .bidirectionalSelectWrapper .centerPart .btnWrapper .switchBtnUnClickable{
