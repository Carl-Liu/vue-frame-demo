<template>
  <div>
    <div class="pageSwitch">
      <div class="item icon-marvelIcon-04" :class="{disableIcon:curPageIndex == 1}" @click.stop="onPreClick"></div>
      ...
      <div class="item icon-marvelIcon-02" :class="{disableIcon:curPageIndex == pages}" @click.stop="onNextClick"></div>
