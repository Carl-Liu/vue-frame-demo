    ...
    <div class="tipDialogWrapper">
      ...
      <div class="tipDialogContArea">
        ...
        <div class="rightMessageCont">
          <div class="MessageTitle errorTitle" v-if="tipType == 'error'">{{$t('tip_error')}}</div>
          <div class="MessageTitle warningTitle" v-else-if="tipType == 'warning'">{{$t('tip_warning')}}</div>
          <div class="MessageTitle tipTitle" v-else="tipType == 'tip'" >{{$t('tip_info')}}</div>
          <div name="dialogCont" class="customContArea">{{confirmCont}}</div>
        </div>
      </div>
      <div class="tipDialogBtnArea">
        <marvel-icon-txt-button v-if="showOkBtn" :label="$t('marvelConfirm_confirm')"
                                icon="icon-checkmark" classCustom="buttonClassCustom"
                                v-on:onClick="onClickOK"></marvel-icon-txt-button>
        <marvel-icon-txt-button v-if="showCancelBtn" :label="$t('marvelConfirm_cancel')"
                                icon="icon-cross" classCustom="buttonClassCustom"
