  ...
  <div class="diffContent">
    <div style="padding:10px; overflow: hidden;">
      <!--<div class="switchArea">
        <div>{{$t('diff_difference')}}</div>
        <div><marvel-switch ref="showDiffId"
                            id="swId"
                            check="false"
                            v-on:onClick="onChange4Switch"></marvel-switch></div>
        <div>{{$t('diff_all')}}</div>

      </div>-->

      <div class="auditLegendPanel">
...
<script>
  import MarvelSwitch from "../select/MarvelSwitch";
