...
&lt;marvel-select-card ref="ref12" :items="items" size="mini"&gt;&lt;/marvel-select-card&gt;
    ...
    <!--2级 end-->
    <!--2级 start-->
    <div class="title level2">双向选择</div>
    <div class="describe">
      双向选择
    </div>
    <div class="showArea">
      <marvel-tab :tabItems="tabItems5">
        <marvel-tab-item :isActive="tabItems5[0].isActive">
          <div class="showAreaInner" style="height: 180px">
            <!--2级DemoView start-->
