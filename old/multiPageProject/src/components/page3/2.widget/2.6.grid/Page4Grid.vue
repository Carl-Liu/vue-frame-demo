        ...
        <marvel-tab-item :isActive="tabItems3[0].isActive">
          <div class="showAreaInner">
            ...
            <div style="width:800px;height:300px;">
              <button @click="removeRowEx2">removeRow</button>
...
&lt;marvel-grid-ex ref="gridEx"
    ...
    <!--2级 start-->
    <div class="title level2">表格-3 固定列表格</div>
    <div class="describe">
      表格-3 固定列表格，基于表格2.1所使用的表格空间进行封装。
    </div>
    <div class="showArea" style="height: 450px;">
    ...
    <!--2级 start-->
    <div class="title level2">表格-4</div>
    <div class="describe">
      表格-4
    </div>
    <div class="showArea" style="height: 450px;">
    ...
    <!--2级 start-->
    <div class="title level2">表格-5优先级排列表</div>
    <div class="describe">
      表格-优先级排列表
    </div>
    <div class="showArea" style="height: 450px;">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      removeRowEx2: function(){
        this.$refs.gridEx2_2.removeRow(0);
      },
      //endregion
