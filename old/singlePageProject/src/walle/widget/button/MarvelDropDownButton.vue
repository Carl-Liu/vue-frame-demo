<template>
  <div class="dropdownBtnWrapper" v-bind:class="status">
    <div class="dropdownBtn"
      ...
      <div class="label" v-on:click="showOrHide" :class="labelClass">
        <div class="icon"
...
<script>
  export default {
    ...
    props: ["disable", "width", "maxHeight", "status", "errMsg"],
    data: function () {
      return {
        items: [],
...
<style scoped>
  ...
  .blackBg .dropdownBtn .options .mouseDown .name, .blackBg .dropdownBtn .options .mouseDown .icon {
    color: #fff !important;
  }
