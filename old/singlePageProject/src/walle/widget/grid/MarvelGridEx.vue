...
<template>
  <div class="gridWrapper">
            ...
            <template v-for="title in titles" v-if="title.visible">
              ...
              <td v-if="title.type == 'progress'" :style="getTdStyle(title, row)">
                <div class="progressBarWrapper" :title="getCellValueByKey(title.key, row)">
                  <div class="progress" :style="{width:getCellValueByKey(title.key, row),'background-color':getProgressColorByKey(title.key, row)}"></div>
                </div>
    ...
    <div v-if="columnConfig" class="columnConfig icon-cog" :title="$t('columnConfig')" @click="_showColumnConfigPanel"></div>
...
<style scoped>
  ...
  * {
  ...
  .blackBg .gridWrapper .grid .gridCont tbody tr .disableIcon{
    color: #777 !important;
  }
  ...
  .blackBg .gridWrapper .grid .gridCont tbody .evenRow {
  ...
  .blackBg .gridWrapper .grid .gridCont tbody .rowHover {
    background-color: rgba(0,200,250,0.3) ;
  }
  ...
  .blackBg .icon-marvelIcon_2-09{
    color: #ffffff !important;
  }

  .blackBg .icon-marvelIcon_2-10{
    color: #0093ff !important;
  }
