...
&lt;marvel-chart-stack-line ref="ref5" id="id5" theme="dark"&gt;&lt;/marvel-chart-stack-line&gt;
    ...
    <!--2级 start-->
    <div class="title level2">Graph Force</div>
    <div class="describe">
      Graph Force
    </div>
    <div class="showArea">
    ...
    <!--2级 start-->
    <div class="title level2">Tree Map</div>
    <div class="describe">
      Tree Map
    </div>
    <div class="showArea">
...
<script>
  ...
  export default {
    ...
    mounted: function () {
      ...
      //9.graphForce
      self.$refs.ref9.init();
      self.$refs.ref9.setData(self.graphForceData, this.graphForceCategories, true);
      //10.tree map
      self.$refs.ref10.setData(this.treeMap, this.onTreeMapClick);
      //#endregion
    },
